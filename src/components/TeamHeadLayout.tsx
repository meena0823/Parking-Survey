...
export default function TeamHeadLayout({ currentView, onViewChange, children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 h-screen bg-slate-900 text-white transform transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} flex flex-col`}>
